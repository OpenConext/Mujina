 ...
 */
public final class MyXMLSignature extends SignatureElementProxy {
     ...
     */
    public MyXMLSignature(Document doc, String BaseURI, String SignatureMethodURI)
            throws XMLSecurityException {
     ...
     * @throws XMLSecurityException
     */
    public MyXMLSignature(Document doc, String BaseURI,
     ...
     */
    public MyXMLSignature(Element element, String BaseURI)
