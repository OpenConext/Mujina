...
public class TestHelper {
  ...
  public Response doSamlLogin(final String user, final String password) throws MessageEncodingException, ServletException, IOException,
  ...
  private String doIdpLogin(final String authnRequest, final String user, final String password) throws IOException, IllegalStateException,
      ServletException {
