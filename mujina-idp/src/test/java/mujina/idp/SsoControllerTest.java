...
public class SsoControllerTest extends AbstractIntegrationTest {
  ...
  private static final String LAA_APP_ROLES_ATTRIBUTE = "LAA_APP_ROLES";
  ...
  public void setup () {
    ...
    idpConfiguration.putAttribute(LAA_ACCOUNTS_ATTRIBUTE, "0A123B:0A123C");
    idpConfiguration.putAttribute(LAA_APP_ROLES_ATTRIBUTE, "CCR_Solicitor,CCR_CCRDirector,CCR_CCRGradeA1,CCR_CCRGradeA2,CCR_CCRGradeA3,CCR_CCRGradeB1,CCR_CCRGradeD");
  }
  ...
  private void doSingleSignOn(boolean post) throws Exception {
    ...
    assertThat(String.format("SAML response should contain the %s attribute", LAA_ACCOUNTS_ATTRIBUTE), samlResponse.contains(LAA_ACCOUNTS_ATTRIBUTE));
    assertThat(String.format("SAML response should contain the %s attribute", LAA_APP_ROLES_ATTRIBUTE), samlResponse.contains(LAA_APP_ROLES_ATTRIBUTE));
